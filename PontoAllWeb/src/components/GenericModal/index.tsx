...
function Input({ label, value, action }: InputProps) {
  return (
    <div className="mb-4">
      <label className="block text-text-primary text-sm mb-1 break-all">{label}:</label>
      <input
        type="text"
        className="w-full py-2 pl-4 text-sm text-text-primary rounded border border-gray-100 focus:outline-none focus:border-gray-300"
        value={value}
        onChange={(e) => {
